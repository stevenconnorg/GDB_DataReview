# Batch Import Metadata from GDB {#imMetaGDB}
...
```{r imMetaArcafter, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Opening the Item Description to view updated Metadata",fig.align = 'center'}
