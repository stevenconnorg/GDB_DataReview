...
This report was created using R \citep{R-base} with the following
packages: bookdown \citep{R-bookdown}, knitr \citep{R-knitr}, rmarkdown
\citep{R-rmarkdown}, and tinytex \citep{R-tinytex}. For posterity,
package information is listed below:
