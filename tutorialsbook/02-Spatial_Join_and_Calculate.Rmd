...
```{r sjcopentool, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Opening the toolbox",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r sjcbefore, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Missing RPSUID attributes for Site Point featuresl",fig.align='center',out.extra='', out.width = '80%'}
...
```{r sjcparams, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Tool parameters",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r sjcmessages, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Tool parameters",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r sjcafter, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Updated attributes after running the tool",fig.align='center',out.extra='', out.width = '80%'}
