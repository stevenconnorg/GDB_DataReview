# Spatial Join and Calculate {#spatjoinCalc}
## Overview
...
7. **Search Distance (data type: String)** - If the overlap type parameter is equal to "WITHIN_A_DISTANCE_GEODESIC", "WITHIN_A_DISTANCE", "WITHIN_A_DISTANCE_3D", "INTERSECT", "INTERSECT_3D", "HAVE_THEIR_CENTER_IN", "CONTAINS", or "WITHIN", you must provide a search distance.
