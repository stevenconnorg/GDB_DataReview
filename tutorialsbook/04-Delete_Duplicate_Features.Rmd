...
```{r delFopen, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Opening the Delete Duplicate Features tool",fig.align = 'center',out.extra=''}
...
```{r delFmessages, cache=FALSE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Delete Duplicate Features messages",fig.align = 'center',out.extra=''}
