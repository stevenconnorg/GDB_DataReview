...
```{r jcopen, cache=TRUE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Opening the Tool",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r jcparams, cache=TRUE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Tool parameters",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r batch, cache=TRUE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Running a tool in batch",fig.align = 'center',out.extra='', out.width = '80%'}
...
```{r jcbefore, cache=TRUE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Attribues before running the tool",fig.align = 'center',out.extra='', out.width = '80%'}
knitr::include_graphics("figures/joinCalc-before.jpg",auto_pdf = TRUE)
```


```{r jcafter, cache=TRUE,echo=FALSE,message=FALSE,error=FALSE,warning=FALSE,fig.cap="Attributes after running the tool",fig.align = 'center',out.extra='', out.width = '80%'}
