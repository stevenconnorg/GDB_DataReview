...
#lyr = str(pointFc)+"_tmpLayer"
#arcpy.MakeFeatureLayer_management(pointFc,lyr)
#mxd = arcpy.mapping.MapDocument("CURRENT")
#df = arcpy.mapping.ListDataFrames(mxd)[0]
#addLayer = arcpy.mapping.Layer(lyr)
#arcpy.mapping.AddLayer(df, addLayer, "TOP")
#arcpy.AddJoin_management (str(pointFc)+"_tmpLayer", updateFld, joinFc, joinValFld,join_type="KEEP_COMMON")